...
mixin _$PostModel {
  ...
  String get photoPublicId => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      photoUrl: null == photoUrl
          ...
          : photoUrl // ignore: cast_nullable_to_non_nullable
              as String,
      photoPublicId: null == photoPublicId
          ? _value.photoPublicId
          : photoPublicId // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_PostModel with DiagnosticableTreeMixin implements _PostModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PostModel(id: $id, title: $title, content: $content, photoUrl: $photoUrl, photoPublicId: $photoPublicId, createdAt: $createdAt, updatedAt: $updatedAt, userId: $userId, likeCount: $likeCount, dislikeCount: $dislikeCount)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('photoPublicId', photoPublicId))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.photoPublicId, photoPublicId) ||
                other.photoPublicId == photoPublicId) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, content, photoUrl,
      photoPublicId, createdAt, updatedAt, userId, likeCount, dislikeCount);
...
abstract class _PostModel implements PostModel {
  const factory _PostModel(
      ...
      required final String photoPublicId,
